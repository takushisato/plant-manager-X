...
class Permission(BaseModel):
    ...
    can_manage_own_attendance = models.BooleanField(
        "勤怠アクセス：自分のみ管理", default=False
    )
    can_manage_all_attendance = models.BooleanField(
        "勤怠アクセス：全体管理", default=False
    )
    can_view_production_plan = models.BooleanField(
        "生産計画アクセス：閲覧", default=False
    )
    can_edit_production_plan = models.BooleanField(
        "生産計画アクセス：編集・削除", default=False
    )
