    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_number', models.CharField(max_length=100, verbose_name='注文番号')),
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='trade_flow.customer', verbose_name='顧客')),
            ],
            options={
                'verbose_name': '受注',
