...
from apps.mail.serializer import MailGroupWithDetailSerializer
...
class MailGroupView(APIView):
    ...
    @extend_schema(
        responses={200: MailGroupWithDetailSerializer(many=True)},
        tags=["mail"],
    ...
    def get(self, request):
        ...
        serializer = MailGroupWithDetailSerializer(groups, many=True)
