    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('defect_detail', models.CharField(max_length=2000, verbose_name='不具合詳細')),
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='trade_flow.order', verbose_name='注文')),
            ],
            options={
                'verbose_name': '不具合連絡',
