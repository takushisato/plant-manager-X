...
class TestAttendanceRecordPut:
    ...
    def test_update_success(self, client, authed_user, record):
        ...
        payload = {"end_time": "17:30", "note": "退勤時間修正"}

        response = client.put(
            f"/api/attendance/records/{record.id}/", data=payload, format="json"
        )
    ...
    def test_invalid_time_order(self, client, authed_user, record):
        ...
        """
        client.force_authenticate(user=authed_user)
        payload = {"start_time": "17:00", "end_time": "09:00"}
    ...
    def test_outside_work_pattern(self, client, authed_user, record):
        ...
        """
        client.force_authenticate(user=authed_user)
        payload = {"start_time": "08:00", "end_time": "18:30"}
